...
import '../../styles/special/winter.css';
...
const WinterGuide = () => {
    ...
    return (
        <div className="winter-page">
            {/* Snowflakes Layer */}
            <div className="winter-snowflakes-layer">{createWinterSnowflakes()}</div>
            ...
            <div className="winter-container">
                ...
                <section className="winter-section winter-credit">
                    ...
                    <div className="winter-credit-content">
                        ...
                        <p>
                            For the winter tiles:{' '}
                            <a
                                href="https://cuddlyclover.itch.io"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                CuddlyClover
                ...
                <div className="winter-content">
                    ...
                    <section className="winter-section">
                        <h2 className="winter-section-title">
                            Coming December 25th (Skin preview the 20th of December)
                        </h2>
                        <motion.div className="winter-cardinal" whileHover={{ scale: 1.02 }}>
                            <img src="/Cardinals/Skins/Esen%20W/Elsena_W.png" alt="Esen W" />
                    ...
                    <section className="winter-section winter-creatures">
                        ...
                        <div className="winter-creatures-grid">
                            ...
                            <motion.div
                                ...
                                whileHover={{ scale: 1.02 }}
                            >
                                <img src="/Luminals/enchanted/Blizou.png" alt="Enchanted Blizou" />
                                <div className="winter-creature-info">
                                    <h3>Enchanted Blizou</h3>
                                    <p className="winter-creature-type">Winter Enchanted</p>
                                    <p className="winter-creature-rarity">★★★★</p>
                                </div>
                                <img src="/Luminals/enchanted/Huky.png" alt="Enchanted Huky" />
                                <div className="winter-creature-info">
                                ...
                                <img
                                    src="/Luminals/enchanted/Zahakyu.png"
                                    alt="Enchanted Zahakyu"
                                />
                                <div className="winter-creature-info">
                            ...
                            <motion.div
                                ...
                                whileHover={{ scale: 1.02 }}
                            >
                                <img src="/Luminals/mystic/Woka.png" alt="Mystic Woka" />
                                <div className="winter-creature-info">
                                    <h3>Mystic Woka</h3>
...
const RewardCard: React.FC<WinterRewardCardProps> = ({ title, reward, description }) => (
    <motion.div className="winter-reward-card" whileHover={{ scale: 1.02 }}>
        <h3>{title}</h3>
