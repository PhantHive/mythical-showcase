...
const termsContent = `
  ...
  <p>By using Mythical, you agree that any disputes will be handled at Phearion's discretion. You waive your right to initiate legal proceedings against Phearion unless required by applicable law. Any disputes not resolved internally will be subject to the exclusive jurisdiction of the courts of **France**.</p>
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    >
                        <div className="mb-1 inline-flex items-center gap-1 md:mb-3 md:gap-2">
                            <FaFileContract className="text-sm text-purple-400 md:text-2xl lg:text-3xl" />
